...
<div class="d-flex admin-wrapper">
    <aside class="sidebar d-flex flex-column">
        ...
        <nav class="nav flex-column py-3">
            ...
            <a class="nav-link active" href="${pageContext.request.contextPath}/admin/reviews"><i class="bi bi-star me-2"></i>Đánh giá khách hàng</a>
    ...
    <main class="content-area">
        <div class="topbar d-flex justify-content-between align-items-center">
            <div>
                ...
                <small class="text-muted">Quản lý đánh giá của khách hàng</small>
            </div>
        </div>

        <div class="dashboard-body">
            <c:if test="${param.success == 'delete'}">
                <div class="alert alert-success">Xóa đánh giá thành công.</div>
            </c:if>

            <div class="card">
                <div class="card-header bg-white fw-semibold">Danh sách đánh giá</div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <c:forEach var="r" items="${reviews}" varStatus="status">
                            <tr>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${not empty r['comment'] && r['comment'].length() > 50}">
                                ...
                                <td>
                                    <form action="${pageContext.request.contextPath}/admin/reviews" method="post" style="display:inline;">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-outline-danger" onclick="return confirm('Bạn có chắc muốn xóa?')" title="Xóa">
